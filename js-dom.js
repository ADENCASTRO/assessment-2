...
document.getElementById('login-button').addEventListener('click', function() {
  ...
  document.getElementById('alert-form').addEventListener('submit', function(event) {
    ...
    const alertMessage = document.getElementById('alert-text').value;
    alert(alertMessage);
  });

  document.getElementById('add-item-button').addEventListener('dblclick', function() {
  ...
  document.getElementById('red-button').addEventListener('click', function() {
    document.querySelectorAll('.changes-colors').forEach(function(element) {
  ...
  document.getElementById('calculate-button').addEventListener('click', function() {
    const number = parseInt(document.getElementById('factorial-input').value, 10);
